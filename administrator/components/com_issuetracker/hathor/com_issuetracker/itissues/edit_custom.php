      ...
      <div id="customFieldsContainer">
         <ul class="adminformlist" id="customFields">
            <?php if (!empty($this->custom) ) foreach($this->custom as $extraField): ?>
               ...
               <?php } else { ?>
                  <li>
                     <?php $required = false; $required = $this->checkrequired($extraField->value); ?>
                     <label for="CustomField_<?php echo $extraField->id; ?>" id="ITCustomField_<?php echo $extraField->id.'-id'; ?>"><?php echo $extraField->name; ?><?php if ($required ) echo '<span class="star">&#160;*</span>'; ?></label>
