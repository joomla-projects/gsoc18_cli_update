...
<form action="<?php echo JRoute::_('index.php?option=com_issuetracker&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="type-form" class="form-validate">
   <div class="width-60 fltlft">
      <fieldset class="adminform">
         ...
         <li><?php echo $this->form->getLabel('priority_name'); ?>
         <?php echo $this->form->getInput('priority_name'); ?></li>

         <li><?php echo $this->form->getLabel('ranking'); ?>
         <?php echo $this->form->getInput('ranking'); ?></li>

         <li><?php echo $this->form->getLabel('response_time'); ?>
         <?php echo $this->form->getInput('response_time'); ?></li>

         <li><?php echo $this->form->getLabel('resolution_time'); ?>
         <?php echo $this->form->getInput('resolution_time'); ?></li>
