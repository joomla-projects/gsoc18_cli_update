 ...
 */
class IssueTrackerTableItstatus extends JTable
{
   ...
   function __construct(& $db){
      parent::__construct('#__it_status', 'id', $db);
   }
   ...
   public function store($updateNulls = false)
   {
      ...
      if ( ! $this->id ) {  // New status. A status created_on and created_by field can not be set by the user,
