...
<div class="liveupdate">
	<div class="liveupdate-ftp">
		...
		<form name="adminForm" id="adminForm" action="index.php" method="get">
			<input name="option" value="<?php echo JFactory::getApplication()->input->get('option','')?>" type="hidden" />
			<input name="view" value="<?php echo JFactory::getApplication()->input->get('view','liveupdate')?>" type="hidden" />
