...
<form action="<?php echo JRoute::_('index.php?option=com_issuetracker&view=itstatus&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="type-form" class="form-validate">
   <div class="span12 row-fluid form-horizontal">
      <?php echo JHtml::_('bootstrap.startTabSet', 'statusTab', array('active' => 'general')); ?>

         <?php echo JHtml::_('bootstrap.addTab', 'statusTab', 'general', JText::_('COM_ISSUETRACKER_STATUS_DETAILS', true)); ?>
         ...
         <?php echo JHtml::_('bootstrap.addTab', 'statusTab', 'audit', JText::_('COM_ISSUETRACKER_AUDIT_INFORMATION', true)); ?>
