...
if ($saveOrder) {
   $saveOrderingUrl = 'index.php?option=com_issuetracker&task=customfieldgroups.saveOrderAjax&tmpl=component';
   JHtml::_('sortablelist.sortable', 'cfgroupList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
   ...
   <table class="ittable table-striped" id="cfgroupList">
      <thead>
         <tr>
               ...
               <td class="center">
                  <div class="btn-group">
                     ...
                     <?php
                        ...
                        JHtml::_('actionsdropdown.' . $action, 'cb' . $i, 'customfieldgroups');
