 ...
 */
class IssuetrackerViewItstatuslist extends JViewLegacy
{
   protected $items;
   ...
   protected function addToolbar()
   {
      ...
      $jversion = new JVersion();
      if( version_compare( $jversion->getShortVersion(), '3.1', 'ge' ) ) {
         JHtmlSidebar::setAction('index.php?option=com_issuetracker&view=itstatuslist');
   ...
   {
      return array(
        'a.status_name' => JText::_('COM_ISSUETRACKER_STATUS_NAME'),
