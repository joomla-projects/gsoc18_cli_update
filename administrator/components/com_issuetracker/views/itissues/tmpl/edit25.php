...
if (version_compare( $version->RELEASE, '2.5', '<=')) {
   if(JFactory::getApplication()->get('jquery') !== true) {
       $jquery_cdn = $this->params->get( 'jquery_cdn_link', '//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js');
...
<form action="<?php echo JRoute::_('index.php?option=com_issuetracker&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="issue-form" class="form-validate">
   <div class="width-100 fltlft">
      ...
      <fieldset class="adminform">
         ...
         <li><?php echo $this->form->getLabel('progresspublic'); ?>
         <?php echo $this->form->getInput('progresspublic'); ?></li>
