...
if ($saveOrder) {
   $saveOrderingUrl = 'index.php?option=com_issuetracker&task=attachments.saveOrderAjax&tmpl=component';
   JHtml::_('sortablelist.sortable', 'attachList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
      ...
      <table class="ittable table-striped" id="attachList">
         <thead>
            <tr>
