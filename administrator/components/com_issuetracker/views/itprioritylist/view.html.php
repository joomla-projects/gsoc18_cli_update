...
class IssuetrackerViewItprioritylist extends JViewLegacy
{
   ...
   {
      return array(
        'a.priority_name' => JText::_('COM_ISSUETRACKER_PRIORITY_NAME'),
        'a.ranking' => JText::_('COM_ISSUETRACKER_RANKING'),
        'a.response_time' => JText::_('COM_ISSUETRACKER_RESPONSE_TIME'),
        'a.resolution_time' => JText::_('COM_ISSUETRACKER_RESOLUTION_TIME'),
