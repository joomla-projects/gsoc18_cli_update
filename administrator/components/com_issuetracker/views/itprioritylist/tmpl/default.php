...
if ($saveOrder) {
   $saveOrderingUrl = 'index.php?option=com_issuetracker&task=itprioritylist.saveOrderAjax&tmpl=component';
   JHtml::_('sortablelist.sortable', 'priorityList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
   ...
   <table class="ittable table-striped" id="priorityList">
      <thead>
         <tr>
               ...
               <td class="center">
                  <div class="btn-group">
                     ...
                     <?php
                        ...
                        JHtml::_('actionsdropdown.' . $action, 'cb' . $i, 'itprioritylist');
                        $action = $trashed ? 'untrash' : 'trash';
                        JHtml::_('actionsdropdown.' . $action, 'cb' . $i, 'itprioritylist');
                        echo JHtml::_('actionsdropdown.render', $this->escape($item->priority_name));
                     ?>
                  </div>
               </td>
            <?php } ?>
