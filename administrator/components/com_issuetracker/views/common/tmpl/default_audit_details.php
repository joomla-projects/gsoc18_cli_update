...
/*
 *
 * @Version       $Id: default_audit_details.php 2167 2016-01-01 16:41:39Z geoffc $
...
<div class="control-group">
   <div class="control-label">
      <?php echo $this->form->getLabel('modified_on'); ?>
   </div>
   <div class="controls">
      <input type="text" name="jform[modified_on]" id="jform_modified_on" value="<?php echo $d1; ?>" size="40" disabled="disabled" readonly="readonly"/>
